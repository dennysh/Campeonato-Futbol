...
import { register } from '../api/cronograma';
  ...
  return (
    <div style={{ minHeight: '100vh', display: 'flex', alignItems: 'center', justifyContent: 'center', background: '#f9fafb' }}>
      <div style={{ background: '#fff', borderRadius: 12, border: '1px solid #e5e7eb', padding: '2.5rem 2rem', width: '100%', maxWidth: 380 }}>
        <h1 style={{ margin: '0 0 0.25rem', fontSize: 22, textAlign: 'center' }}>Crear cuenta</h1>
        ...
        <form onSubmit={handleSubmit} style={{ display: 'flex', flexDirection: 'column', gap: '1rem' }}>
          <div>
            ...
            <input
              ...
              required autoFocus placeholder="Tu nombre completo"
